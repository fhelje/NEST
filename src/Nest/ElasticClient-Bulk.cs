            ...
            using (var jw = new JsonTextWriter(sw))
            {
                ...
                foreach (var @object in objects)
                {
                    ...
                    jw.WriteStartObject();
                        ...
                        jw.WriteStartObject();
                            jw.WritePropertyName("_index"); jw.WriteValue(index);
                            jw.WritePropertyName("_type"); jw.WriteValue(typeName);
                            if (!id.IsNullOrEmpty())
                                jw.WritePropertyName("_id"); jw.WriteValue(id);
                        jw.WriteEndObject();
                    jw.WriteEndObject();
                    jw.WriteRaw("\n");
                    if (command == "index")
                    {
                        this.Serializer.SerializeStream(jw, @object, Formatting.None);
                        jw.WriteRaw("\n");
                    }
                }
                return sw.ToString();
